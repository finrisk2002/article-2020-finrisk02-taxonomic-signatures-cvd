...
#' ggnet2repel - Plot a network with ggplot2, hacked to incorporate ggrepel
#'
...
ggnet2repel <- function(
  ...
  if (!is_one(l) || unique(l) != "") {
    ...
    if (geom_text_or_label == "text") {
    ...
    } else if (geom_text_or_label == "label") {
      p = p +
        geom_label_repel(
          label = l,
          alpha = label.alpha,
      ...
      stop("incorrect geom_text_or_label value")
    }
