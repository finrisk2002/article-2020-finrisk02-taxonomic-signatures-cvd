...
analysis_ident <- "noplasmid_norxj01"
...
phylum_level_phyloseq_path <- paste0(input_datadir,
    "phfinrisk_phylum_ok_drop50k_2018-12-21_nop_norxj01.rds")
genus_level_phyloseq_path <- paste0(input_datadir,
    "phfinrisk_genus_all_drop50k_2018-12-21_nop_norxj01.rds")
species_level_phyloseq_path <- paste0(input_datadir,
    "phfinrisk_species_all_drop50k_2018-12-21_nop_norxj01.rds")
