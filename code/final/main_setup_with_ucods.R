# set up without plasmids, with healthy food index, without cause of death.
...
phylum_level_phyloseq_path <- phylum_level_phyloseq_noplasmid_hfc_ucod_path
genus_level_phyloseq_path <- genus_level_phyloseq_noplasmid_hfc_ucod_path
species_level_phyloseq_path <- species_level_phyloseq_noplasmid_hfc_ucod_path

network_identities_path <- paste0(datadir,"/net_components.rds") # if missing, run compute_spieceasi_cox_figures.R
functional_activities_path <- paste0(input_datadir,"function_activity.rds")
